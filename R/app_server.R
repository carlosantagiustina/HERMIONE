...
app_server <- function(input, output, session) {
  ...
  output$controlroom_text=renderUI({textyle(tags$p(hermione_controlroom_text[hermione_controlroom$step]),delay = "50",duration = "50",color = "black", class = "ex1")})#duration="100"
